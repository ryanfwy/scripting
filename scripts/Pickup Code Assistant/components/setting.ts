...
1. 取餐或取件码：仅识别纯数字（含前导0，如0135、992）或「1个字母+数字」组合（如A022、B109）或「数字.短句」组合（如8.今日是好日）或「数字+横杠」组合（如1-2-1011），排除数字字母穿插的无效编码（如5G10、3A8B）
2. 对应商家信息：需提取完整商家名称（如 麦当劳、喜茶、星巴克、菜鸟驿站）
